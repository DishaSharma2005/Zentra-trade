...
return (
 <div className="container">
        ...
        <div className="row p-4 mt-2 mb-5  text-muted fs-5 " style={{lineHeight:"1.7"}}>
            <div className="col-12 col-md-6 p-3 text-center text-md-center">
                 <img src="/media/images/nithinKamath.jpg" alt="Nithin Kamath" className="img-fluid w-75 w-md-50 rounded-circle mb-3"/>
                 
                     <h3 className='mt-3'>Nithin Kamath</h3>
                     <p>Founder & CEO</p>
                 
            </div>
            <div className="col-12 col-md-6 p-3 fs-6 fs-md-5 text-center text-md-start" >
