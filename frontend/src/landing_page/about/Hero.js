...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-3 p-md-4 mt-4 mt-md-5 mb-5 border-top text-muted fs-6 fs-md-5 " style={{lineHeight:"1.7"}}>
        ...
        <div className="col-12 col-md-6 p-3 p-md-5 text-center text-md-start mt-4 mt-md-0">
