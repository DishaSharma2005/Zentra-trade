...
function Stats() {
    ...
    <div className='container p-4'>
        <div className='row'>
            <div className='col'>
                <h1 className='mb-4 mt-4'>Trust with confidence</h1>
            ...
            <div className='col mt-5'>
                <img src="media/images/ecosystem.png" alt="Users Icon" style={{width:"80%"}} />
                <div className='text-center'>
        
                    <a href=''className='mx-5' style={{textDecoration:"none"}}>Explore our Products<i class="fa fa-long-arrow-right"></i>
</a>
                    <a href=''style={{textDecoration:"none"}}>Try our demo kit <i class="fa fa-long-arrow-right"></i>
</a>
                </div>
            </div>
        </div>
